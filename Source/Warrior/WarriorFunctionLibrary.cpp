...
bool UWarriorFunctionLibrary::IsValidBlock(AActor* InAttacker, AActor* InDefender)
{
	...
	// const FString DebugString = FString::Printf(TEXT("DotResult: %f %s"), DotResult, DotResult<0.f? TEXT("Valid Block") : TEXT("Invalid Block"));
	//
	...
	EWarriorCountDownActionOutput& CountDownOutput, FLatentActionInfo LatentInfo)
{
	...
	if (!World)
	{
		UE_LOG(LogTemp, Warning, TEXT("World Var ve return"))
		return;
	}
