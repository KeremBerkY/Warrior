...
void AWarriorProjectileBase::HandleApplyProjectileDamage(APawn* InHitAPawn, const FGameplayEventData& InPayload)
{
	...
	const bool bWasApplied = UWarriorFunctionLibrary::ApplyGameplayEffectSpecHandleToTargetActor(GetInstigator(), InHitAPawn, ProjectileDamageEffectSpecHandle);
